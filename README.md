...
Standardized categorical fields (Outlet Size, Outlet Location, Item Type)
Corrected inconsistent naming and text formatting
Changed data types for numerical accuracy
...
Aggregated Item Count by Outlet and Category
Created KPI measures using DAX for:
1.Total Sales
2.Average Sales
3.Number of Items
4.Average Rating
...
🏪 Outlet Performance
Compares sales by outlet size (Small, Medium, High)
Analyzes revenue distribution across Tier 1, Tier 2, and Tier 3 cities

📦 Product & Category Insights
Sales comparison by item type
Identifies top-selling and low-performing categories
...
✔ KPI Cards
Purpose:
To give management a quick snapshot of overall business health.
Insight:
...
Purpose:
To analyze whether Low Fat or Regular products contribute more to total sales.
Insight:
...
Purpose:
To compare outlet-wise sales distribution segmented by fat content.
Insight:
...
Purpose:
To evaluate whether older or newer outlets perform better.
Insight:
...
Purpose:
To analyze correlation between outlet size (Small, Medium, Large) and revenue.
Insight:
...
Purpose:
To visualize sales performance across different locations.
Insight:
...
Purpose:
To provide a comprehensive comparison of all KPIs across outlet types.
Insight:
